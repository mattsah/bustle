...
abstract class UserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT person, password FROM users WHERE person = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_PERSON, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_PERSON, $keys, Criteria::IN);
    }
    ...
    public function filterByPerson($person, $comparison = null)
    {
        if ($person instanceof \Person) {
            return $this
                ->addUsingAlias(UserTableMap::COL_PERSON, $person->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserTableMap::COL_PERSON, $person->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
