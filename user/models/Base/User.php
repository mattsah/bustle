...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person !== $v) {
            $this->person = $v;
            $this->modifiedColumns[UserTableMap::COL_PERSON] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PERSON)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PERSON)) {
            $criteria->add(UserTableMap::COL_PERSON, $this->person);
        }
        if ($this->isColumnModified(UserTableMap::COL_PASSWORD)) {
    ...
    public function hashCode()
    {
        ...
        //relation users_person_fkey to table people
    ...
    /**
     * Generic method to set the primary key (person column).
     *
    ...
    if (is_callable(array('\Person', $name))) {
        if (!$delegate = $this->getPerson()) {
            $delegate = new ChildPerson();
            $this->setPerson($delegate);
        }
