 ...
 *
 *
 * @method     ChildEmployeeQuery orderByPersonId($order = Criteria::ASC) Order by the person column
 * @method     ChildEmployeeQuery orderByCompanyId($order = Criteria::ASC) Order by the company column
 * @method     ChildEmployeeQuery orderByPosition($order = Criteria::ASC) Order by the position column
 *
 * @method     ChildEmployeeQuery groupByPersonId() Group by the person column
 * @method     ChildEmployeeQuery groupByCompanyId() Group by the company column
 * @method     ChildEmployeeQuery groupByPosition() Group by the position column
 *
 ...
 *
 * @method     ChildEmployeeQuery leftJoinPerson($relationAlias = null) Adds a LEFT JOIN clause to the query using the Person relation
 * @method     ChildEmployeeQuery rightJoinPerson($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Person relation
 * @method     ChildEmployeeQuery innerJoinPerson($relationAlias = null) Adds a INNER JOIN clause to the query using the Person relation
 *
 * @method     \CompanyQuery|\PersonQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildEmployee findOneByPersonId(int $person) Return the first ChildEmployee filtered by the person column
 * @method     ChildEmployee findOneByCompanyId(int $company) Return the first ChildEmployee filtered by the company column
 * @method     ChildEmployee findOneByPosition(string $position) Return the first ChildEmployee filtered by the position column *
 ...
 *
 * @method     ChildEmployee requireOneByPersonId(int $person) Return the first ChildEmployee filtered by the person column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildEmployee requireOneByCompanyId(int $company) Return the first ChildEmployee filtered by the company column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildEmployee requireOneByPosition(string $position) Return the first ChildEmployee filtered by the position column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildEmployee[]|ObjectCollection findByPersonId(int $person) Return ChildEmployee objects filtered by the person column
 * @method     ChildEmployee[]|ObjectCollection findByCompanyId(int $company) Return ChildEmployee objects filtered by the company column
 * @method     ChildEmployee[]|ObjectCollection findByPosition(string $position) Return ChildEmployee objects filtered by the position column
...
abstract class EmployeeQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @param array[$person, $company] $key Primary key to use for the query
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = EmployeeTableMap::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT person, company, position FROM employees WHERE person = :p0 AND company = :p1';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            EmployeeTableMap::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
    ...
    {
        $this->addUsingAlias(EmployeeTableMap::COL_PERSON, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(EmployeeTableMap::COL_COMPANY, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(EmployeeTableMap::COL_PERSON, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(EmployeeTableMap::COL_COMPANY, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterByPersonId($personId = null, $comparison = null)
    {
        if (is_array($personId)) {
            ...
            if (isset($personId['min'])) {
                $this->addUsingAlias(EmployeeTableMap::COL_PERSON, $personId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($personId['max'])) {
                $this->addUsingAlias(EmployeeTableMap::COL_PERSON, $personId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EmployeeTableMap::COL_PERSON, $personId, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByCompanyId(1234); // WHERE company = 1234
     * $query->filterByCompanyId(array(12, 34)); // WHERE company IN (12, 34)
     * $query->filterByCompanyId(array('min' => 12)); // WHERE company > 12
     * </code>
     *
     * @see       filterByCompany()
     *
    ...
    public function filterByCompanyId($companyId = null, $comparison = null)
    {
        if (is_array($companyId)) {
            ...
            if (isset($companyId['min'])) {
                $this->addUsingAlias(EmployeeTableMap::COL_COMPANY, $companyId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($companyId['max'])) {
                $this->addUsingAlias(EmployeeTableMap::COL_COMPANY, $companyId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EmployeeTableMap::COL_COMPANY, $companyId, $comparison);
    }
    ...
    public function filterByPosition($position = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EmployeeTableMap::COL_POSITION, $position, $comparison);
    }
    ...
    public function filterByCompany($company, $comparison = null)
    {
        if ($company instanceof \Company) {
            return $this
                ->addUsingAlias(EmployeeTableMap::COL_COMPANY, $company->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EmployeeTableMap::COL_COMPANY, $company->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByPerson($person, $comparison = null)
    {
        if ($person instanceof \Person) {
            return $this
                ->addUsingAlias(EmployeeTableMap::COL_PERSON, $person->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EmployeeTableMap::COL_PERSON, $person->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($employee) {
            $this->addCond('pruneCond0', $this->getAliasedColName(EmployeeTableMap::COL_PERSON), $employee->getPersonId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(EmployeeTableMap::COL_COMPANY), $employee->getCompanyId(), Criteria::NOT_EQUAL);
