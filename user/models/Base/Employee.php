...
abstract class Employee implements ActiveRecordInterface
{
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person !== $v) {
            $this->person = $v;
            $this->modifiedColumns[EmployeeTableMap::COL_PERSON] = true;
        }
    ...
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[EmployeeTableMap::COL_POSITION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EmployeeTableMap::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $this->company = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EmployeeTableMap::translateFieldName('Position', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = EmployeeTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCompany !== null && $this->company !== $this->aCompany->getId()) {
            $this->aCompany = null;
        }
    } // ensureConsistency
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'person':
                        ...
                        break;
                    case 'company':
                        $stmt->bindValue($identifier, $this->company, PDO::PARAM_INT);
                        break;
                    case 'position':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmployeeTableMap::COL_PERSON)) {
            $criteria->add(EmployeeTableMap::COL_PERSON, $this->person);
        }
        if ($this->isColumnModified(EmployeeTableMap::COL_COMPANY)) {
            $criteria->add(EmployeeTableMap::COL_COMPANY, $this->company);
        }
        if ($this->isColumnModified(EmployeeTableMap::COL_POSITION)) {
            $criteria->add(EmployeeTableMap::COL_POSITION, $this->position);
        }
    ...
    public function hashCode()
    {
        ...
        //relation employees_company_fkey to table companies
        ...
        //relation employees_person_fkey to table people
    ...
    {
        return (null === $this->getPersonId()) && (null === $this->getCompanyId());
    }
    ...
    {
        if ($this->aCompany === null && ($this->company !== null)) {
            $this->aCompany = ChildCompanyQuery::create()->findPk($this->company, $con);
    ...
    public function getPerson(ConnectionInterface $con = null)
    {
        if ($this->aPerson === null && ($this->person !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPerson->addEmployees($this);
             */
        }
