...
class CompanyTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CompanyTableMap::COL_ID, CompanyTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CompanyTableMap::COL_ID => 0, CompanyTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setPrimaryKeyMethodInfo('companies_id_seq');
        // columns
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to companies     * by a foreign key with ON DELETE CASCADE
     */
