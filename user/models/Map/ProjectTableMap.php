...
class ProjectTableMap extends TableMap
{
     ...
     */
    const COL_TITLE = 'projects.title';

    /**
     * the column name for the parent field
     */
    const COL_PARENT = 'projects.parent';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'projects.description';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Parent', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'parent', 'description', ),
        self::TYPE_COLNAME       => array(ProjectTableMap::COL_ID, ProjectTableMap::COL_TITLE, ProjectTableMap::COL_PARENT, ProjectTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'parent', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Parent' => 2, 'Description' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'parent' => 2, 'description' => 3, ),
        self::TYPE_COLNAME       => array(ProjectTableMap::COL_ID => 0, ProjectTableMap::COL_TITLE => 1, ProjectTableMap::COL_PARENT => 2, ProjectTableMap::COL_DESCRIPTION => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'parent' => 2, 'description' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setPrimaryKeyMethodInfo('projects_id_seq');
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('title', 'Title', 'VARCHAR', true, 64, null);
        $this->addForeignKey('parent', 'Parent', 'INTEGER', 'projects', 'id', false, null, null);
    ...
    {
        $this->addRelation('ProjectRelatedByParent', '\\Project', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':parent',
    1 => ':id',
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('ProjectRelatedById', '\\Project', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':parent',
    1 => ':id',
  ),
), 'CASCADE', 'CASCADE', 'ProjectsRelatedById', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProjectTableMap::COL_TITLE);
            $criteria->addSelectColumn(ProjectTableMap::COL_PARENT);
