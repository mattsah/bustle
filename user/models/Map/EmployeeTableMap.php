...
class EmployeeTableMap extends TableMap
{
     ...
     */
    const COL_PERSON = 'employees.person';

    /**
     * the column name for the company field
     */
    const COL_COMPANY = 'employees.company';

    /**
     * the column name for the position field
     */
    const COL_POSITION = 'employees.position';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('PersonId', 'CompanyId', 'Position', ),
        self::TYPE_CAMELNAME     => array('personId', 'companyId', 'position', ),
        self::TYPE_COLNAME       => array(EmployeeTableMap::COL_PERSON, EmployeeTableMap::COL_COMPANY, EmployeeTableMap::COL_POSITION, ),
        self::TYPE_FIELDNAME     => array('person', 'company', 'position', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('PersonId' => 0, 'CompanyId' => 1, 'Position' => 2, ),
        self::TYPE_CAMELNAME     => array('personId' => 0, 'companyId' => 1, 'position' => 2, ),
        self::TYPE_COLNAME       => array(EmployeeTableMap::COL_PERSON => 0, EmployeeTableMap::COL_COMPANY => 1, EmployeeTableMap::COL_POSITION => 2, ),
        self::TYPE_FIELDNAME     => array('person' => 0, 'company' => 1, 'position' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignPrimaryKey('company', 'CompanyId', 'INTEGER' , 'companies', 'id', true, null, null);
        $this->addColumn('position', 'Position', 'VARCHAR', false, 48, null);
    } // initialize()
  ...
  array (
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getPersonId(), (string) $obj->getCompanyId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Employee) {
                $key = serialize(array((string) $value->getPersonId(), (string) $value->getCompanyId()));
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('PersonId', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('CompanyId', TableMap::TYPE_PHPNAME, $indexType)]));
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(EmployeeTableMap::COL_PERSON);
            $criteria->addSelectColumn(EmployeeTableMap::COL_COMPANY);
            $criteria->addSelectColumn(EmployeeTableMap::COL_POSITION);
        } else {
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(EmployeeTableMap::COL_PERSON, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(EmployeeTableMap::COL_COMPANY, $value[1]));
